...
def main():
    ...
    output_path = os.path.join(output_dir, f"inferred_embeds_{args.wandb_run_name}.pt")
    ...
    # Load the full res_data (using key 99 as before, and groups as defined in trainer config)
    res_data = load_res_data(99, groups_to_load=trainer.c.groups_to_load).to(DEVICE)
